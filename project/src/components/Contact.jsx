        ...
        <div className="flex flex-col-reverse lg:flex-row gap-10">
          ...
          >
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                className="bg-blue-200 hover:bg-blue-100 py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl transition-colors duration-300"
              >
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">youremail@example.com</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-blue-200 flex items-center justify-center">
